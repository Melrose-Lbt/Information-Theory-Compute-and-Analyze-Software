...
namespace InformationTheoryExp_1
{
    partial class Rectify
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.label6.Size = new System.Drawing.Size(339, 42);
            this.label6.TabIndex = 11;
            this.label6.Text = "若所得向量为0向量，则收码无误，否则有错。\r\n\r\n";
            // 
            // label5
            // 
            ...
            this.label5.Text = "假设发送的码字为r，若要对r进行检测，则将r与H的转置相乘。即系统码字与校验矩阵转置相乘";
            ...
            this.label2.Text = "对于校验码的检测而言，可以首先根据生成矩阵得到校验矩阵H。\r\n\r\n由于G = （Ik|P），可以得到 H = （Pt|In-k）。\r\n";
            // 
            // label1
            // 
